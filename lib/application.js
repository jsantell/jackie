...
/**
 * Creates a new Environment object within this application.
 *
 * @param {String} envName
 * @return {Environment}
 */

Application.prototype.createEnvironment = function createEnvironment (envName) {
...
Application.prototype.createVersion = function createVersion (params) {
  ...
  return this._eb.createApplicationVersion(params);
};
